...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { icon: Facebook, href: 'https://www.facebook.com/retro.a.3/', label: 'Facebook' },
    { icon: Instagram, href: 'https://www.instagram.com/retr0_228/', label: 'Instagram' },
  ];
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sand-300">+8801533797042</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Mail className="w-5 h-5 text-primary-400 flex-shrink-0" />
                  <span className="text-sand-300">aumio.nilbd@gmail.com</span>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container-custom section-padding py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-sand-400">
              <span>© 2026 O.I.A Aumio. Made with in Bangladesh</span>
            </div>
