  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm text-sand-500 dark:text-sand-500">
            From {formatPrice(tour.price)}/person
          </span>
        ...
        <div className="flex gap-3">
          <Link 
            ...
            className="flex-1 bg-sand-100 hover:bg-sand-200 dark:bg-sand-800 dark:hover:bg-sand-700 text-sand-700 dark:text-sand-300 font-medium py-2 px-4 rounded-lg transition-colors duration-200 text-center"
          >
            View Details
          </Link>
          <Link 
            href={`/booking?package=${encodeURIComponent(tour.title)}&price=${tour.price}&duration=${tour.duration}&location=${tour.location}`}
            className="flex-1 bg-primary-600 hover:bg-primary-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 text-center"
          >
            Book Now
          </Link>
        </div>
