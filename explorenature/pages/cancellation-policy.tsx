...
const CancellationPolicyPage: React.FC = () => {
  return (
    <>
      <NextSeo
        title="Cancellation Policy - Roam Sight"
        description="Read our comprehensive cancellation and refund policy. Understand the terms for canceling your tour bookings with Roam Sight."
        canonical="https://roamsight.com/cancellation-policy"
        openGraph={{
          title: 'Cancellation Policy - Roam Sight',
          ...
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: 'Cancellation Policy - Roam Sight',
            },
          ],
        }}
      />
              ...
              >
                <div className="bg-sand-50 dark:bg-sand-800 rounded-xl p-8 mb-8">
                  ...
                  <p className="text-sand-600 dark:text-sand-400">
                    This cancellation policy applies to all tour bookings made with Roam Sight. Please read carefully before making a booking.
                  </p>
                </div>
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      ...
                      <ul className="list-disc list-inside space-y-2 text-sand-600 dark:text-sand-400">
                        ...
                        <li>Email us at aumio.nilbd@gmail.com</li>
