...
const PrivacyPolicyPage: React.FC = () => {
  return (
    <>
      <NextSeo
        title="Privacy Policy - Roam Sight"
        description="Learn how Roam Sight collects, uses, and protects your personal information. Read our comprehensive privacy policy."
        canonical="https://roamsight.com/privacy-policy"
        openGraph={{
          title: 'Privacy Policy - Roam Sight',
          description: 'Learn how Roam Sight collects, uses, and protects your personal information.',
          images: [
            {
              url: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200',
              width: 1200,
              height: 630,
              alt: 'Privacy Policy - Roam Sight',
            },
          ],
        }}
      />
              ...
              >
                <div className="bg-sand-50 dark:bg-sand-800 rounded-xl p-8 mb-8">
                  ...
                  <p className="text-sand-600 dark:text-sand-400">
                    This privacy policy explains how Roam Sight collects, uses, and protects your personal information when you use our services.
                  </p>
                </div>
