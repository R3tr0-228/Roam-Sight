              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <span className="ml-2 text-gray-700">aumio.nilbd@gmail.com</span>
                  </div>
                  <div>
  ...
  return (
    <>
      <NextSeo
        ...
        canonical="https://roamsight.com/contact"
        openGraph={{
          title: 'Get in Touch - Roam Sight',
          description: 'Got a question? You might find the answer in our Help centre. Otherwise, see all the ways you can speak to our team below.',
          images: [
...
export const getStaticProps: GetStaticProps = async () => {
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Email',
      details: ['aumio.nilbd@gmail.com', 'We respond within 24 hours']
    },
    {
