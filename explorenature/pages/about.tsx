...
const AboutPage: React.FC<AboutPageProps> = ({ stats: _stats }) => {
  ...
  return (
    <>
      <NextSeo
        title="About Us - Roam Sight"
        description="Learn about Roam Sight's mission to provide unforgettable desert adventures. Meet our team and discover our commitment to safety, sustainability, and authentic experiences."
        canonical="https://roamsight.com/about"
        openGraph={{
          title: 'About Us - Roam Sight',
          description: 'Learn about Roam Sight\'s mission to provide unforgettable desert adventures. Meet our team and discover our commitment to safety, sustainability, and authentic experiences.',
          images: [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-4 text-sand-700 dark:text-sand-300">
                  <p>
                    Founded in 2025 by Q.I.A Aumio, a passionate travel enthusiast, 
                    Roam Sight began as a small operation with a simple mission: to 
