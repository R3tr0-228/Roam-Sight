...
const BookingPage: React.FC<BookingPageProps> = ({ tours }) => {
  ...
  return (
    <>
      <NextSeo
        title="Booking Form - Roam Sight"
        description="Book your dream tour with Roam Sight. Fill out our easy booking form and start your adventure today."
        canonical="https://roamsight.com/booking"
        openGraph={{
          title: 'Booking Form - Roam Sight',
          description: 'Book your dream tour with Roam Sight. Fill out our easy booking form and start your adventure today.',
          images: [
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                      ...
                      <div>
                        ...
                        <span className="ml-2 text-sand-600">
                          {formatPrice(formData.selectedTour?.price || 0)}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-primary-50 rounded-xl p-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sand-700 font-medium">aumio.nilbd@gmail.com</span>
                      </div>
                    </div>
                        ...
                        <>
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                            ...
                            <div className="mt-4 text-2xl font-bold">
                              Starting from {formatPrice(currentTour.price)}
                            </div>
                          </div>
                        </>
                      )}
