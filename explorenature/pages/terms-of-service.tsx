...
const TermsOfServicePage: React.FC = () => {
  return (
    <>
      <NextSeo
        title="Terms of Service - Roam Sight"
        description="Read our terms of service and conditions for using Roam Sight's tour booking services. Understand your rights and responsibilities."
        canonical="https://roamsight.com/terms-of-service"
        openGraph={{
          title: 'Terms of Service - Roam Sight',
          description: 'Read our terms of service and conditions for using Roam Sight\'s tour booking services.',
          images: [
            {
              url: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200',
              width: 1200,
              height: 630,
              alt: 'Terms of Service - Roam Sight',
            },
          ],
        }}
      />
              ...
              >
                <div className="bg-sand-50 dark:bg-sand-800 rounded-xl p-8 mb-8">
                  ...
                  <p className="text-sand-600 dark:text-sand-400">
                    These terms and conditions govern your use of Roam Sight's services. By booking a tour with us, you agree to be bound by these terms.
                  </p>
                </div>
                ...
                <div className="space-y-8">
                  <section>
                    ...
                    <p className="text-sand-600 dark:text-sand-400 leading-relaxed">
                      By accessing and using Roam Sight's website and services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-sand-600 dark:text-sand-400 leading-relaxed">
                      Roam Sight's liability is limited to the amount paid for the tour. We are not responsible for any indirect, incidental, or consequential damages arising from your participation in our tours.
                    </p>
                  </section>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white dark:bg-sand-700 rounded-xl p-8 shadow-soft">
                  ...
                  <a 
                    href="mailto:aumio.nilbd@gmail.com"
                    className="text-primary-600 hover:text-primary-700 font-medium"
                  >
                    aumio.nilbd@gmail.com
                  </a>
                </div>
              </div>
            </div>
