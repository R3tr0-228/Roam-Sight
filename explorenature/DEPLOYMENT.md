# Deployment Guide - Roam Sight

This guide covers various deployment options for the Roam Sight Next.js application.
...
NEXT_PUBLIC_SITE_NAME="Roam Sight"
...
# Database (if needed)
DATABASE_URL=postgresql://user:password@localhost:5432/roamsight
